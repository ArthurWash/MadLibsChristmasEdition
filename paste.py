print("Rachel was finishing up decorating the living room. she placed " + obj1 + " as the center piece on the table.")
...
print("As everyone mingled, drank and played games, they were all " + verb2 + "about the main event.")
